...
@section('header')
<strong>Completed Order Details</strong>
@endsection
@section('content')
<div class="card card-gray">
    <div class="toolbox">
        <div class="row">
            <div class="col-sm-3">
                ...
                <a href="{{route('cart.complete')}}" data-toggle="tooltip" title="" class="btn btn-secondary btn-lg btn-oval">
    ...
    <div class="card-block">
        ...
        <table class="table table-lg">
            ...
            <tbody>
                <p>
                    <strong>All Product of user name [ <span class="text-danger">{{$user->u_name}}</span> ] has been completed</strong>
                </p>
